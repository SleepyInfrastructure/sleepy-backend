...
export const ServerEditSchema = z.intersection(ServerCreateSchema, IDSchema);
...
export const UptimeEndpointEditSchema = z.intersection(UptimeEndpointCreateSchema, IDSchema);
