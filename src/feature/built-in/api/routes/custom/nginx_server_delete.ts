...
import { deleteNginxServer } from "./_util";

class RouteNginxServerDelete extends APIRoute {
    hook(feature: FeatureAPI): void {
        feature.instance.delete(this.path,
            ...
            async (req: RequestWithSchemaQuery<IDSchemaType>, rep) => {
                ...
                /* Delete server */
                const success = await deleteNginxServer(feature.database, req.query.id, session.user);
                if(!success) {
...
export default RouteNginxServerDelete;
